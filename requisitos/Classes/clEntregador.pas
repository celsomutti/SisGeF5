...
begin
  Try
    ...
    begin
      Close;
      SQL.Clear;
      SQL.Text := 'INSERT INTO ' + TABLENAME + '(' + 'COD_CADASTRO, ' +
        'DOM_FUNCIONARIO, ' + 'COD_ENTREGADOR, ' + 'DES_TIPO_DOC, ' +
        'DES_RAZAO_SOCIAL, ' + 'NOM_FANTASIA, ' + 'NUM_CNPJ, ' +
        'DAT_NASCIMENTO, ' + 'NUM_IE, ' + 'UF_RG, ' + 'DAT_EMISSAO_RG, ' +
        'UF_NASCIMENTO, ' + 'NOM_CIDADE_NASCIMENTO, ' + 'NOM_PAI, ' +
        'NOM_MAE, ' + 'NUM_IEST, ' + 'NUM_IM, ' + 'COD_CNAE, ' + 'COD_CRT, ' +
        'NUM_CNH, ' + 'NUM_REGISTRO_CNH, ' + 'DES_CATEGORIA_CNH, ' +
        'DAT_VALIDADE_CNH, ' + 'UF_CNH, ' + 'DAT_1_HABILITACAO, ' +
        'DES_PAGINA, ' + 'COD_AGENTE, ' + 'COD_STATUS, ' + 'DES_OBSERVACAO, ' +
        'DAT_CADASTRO, ' + 'COD_USUARIO, ' + 'VAL_VERBA, ' +
        'VAL_VERBA_COMBUSTIVEL, ' + 'DES_TIPO_CONTA, ' + 'COD_BANCO, ' +
        'COD_AGENCIA, ' + 'NUM_CONTA, ' + 'NOM_FAVORECIDO, ' +
        'NUM_CPF_CNPJ_FAVORECIDO, ' + 'DES_FORMA_PAGAMENTO, ' +
        'COD_CENTRO_CUSTO, ' + 'DOM_VITIMA_ROUBO, ' + 'QTD_VITIMA_ROUBO, ' +
        'DOM_ACIDENTES, ' + 'QTD_ACIDENTES, ' + 'DOM_TRANSPORTE_EMPRESA, ' +
        'QTD_TRANSPORTE, ' + 'DOM_GV, ' + 'DAT_GV, ' + 'NOM_EXECUTANTE, ' +
        'DAT_ALTERACAO, ' + 'DES_CHAVE, ' + 'COD_GRUPO, COD_ROTEIRO) ' + 'VALUES (' +
        ':CADASTRO, ' + ':FUNCIONARIO, ' + ':CODIGO, ' + ':TIPODOC, ' +
        ':NOME, ' + ':FANTASIA, ' + ':CPF, ' + ':NASCIMENTO, ' + ':RG, ' +
        ':UFRG, ' + ':EMISSAORG, ' + ':UFNASCIMENTO, ' + ':NATURALIDADE, ' +
        ':PAI, ' + ':MAE, ' + ':IEST, ' + ':IM, ' + ':CNAE, ' + ':CRT, ' +
        ':CNH, ' + ':REGISTROCNH, ' + ':CATEGORIACNH, ' + ':VALIDADECNH, ' +
        ':UFCNH, ' + ':DATAHABILITACAO, ' + ':PAGINA, ' + ':AGENTE, ' +
        ':STATUS, ' + ':OBS, ' + ':DATACADASTRO, ' + ':USUARIO, ' + ':VERBA, ' +
        ':COMBUSTIVEL, ' + ':TIPOCONTA, ' + ':BANCO, ' + ':AGENCIA, ' +
        ':CONTA, ' + ':FAVORECIDO, ' + ':CPFFAVORECIDO, ' + ':FORMAPAGAMENTO, '
        + ':CENTROCUSTO, ' + ':ROUBO, ' + ':QTDEROUBO, ' + ':ACIDENTES, ' +
        ':QTDEACIDENTES, ' + ':TRANSPORTE, ' + ':QTDETRANSPORTE, ' + ':GV, ' +
        ':DATAGV ,' + ':EXECUTANTE, ' + ':ALTERACAO, ' + ':CHAVE, ' + ':GRUPO, :ROTEIRO)';
  ...
  try
    ...
    begin
      ...
      SQL.Text := 'UPDATE ' + TABLENAME + ' SET ' +
        ...
        'DAT_VALIDADE_CNH = :VALIDADECNH, ' + 'UF_CNH = :UFCNH, ' +
        ...
        'COD_GRUPO = :GRUPO, COD_ROTEIRO = :ROTEIRO  ' + 'WHERE ' + 'COD_CADASTRO = :CADASTRO';
...
begin
  ...
  dm.qryPesquisa.SQL.Text := 'SELECT COD_CADASTRO, DES_RAZAO_SOCIAL, NOM_FANTASIA, DOM_FUNCIONARIO, COD_ROTEIRO FROM ' + TABLENAME +
                             ' WHERE DOM_FUNCIONARIO IN (' + QuotedStr('R') + ',' + QuotedStr('T') + ',' +
                             QuotedStr('P') + ',' + QuotedStr('F') +')';
  dm.ZConn.PingServer;
  dm.qryPesquisa.Open;
