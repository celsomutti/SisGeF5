unit View.SisGeFExpressExtract;
...
type
  Tview_SisGeFExpressExtract = class(TForm)
...
var
  view_SisGeFExpressExtract: Tview_SisGeFExpressExtract;
...
procedure Tview_SisGeFExpressExtract.actionClearBasesExecute(Sender: TObject);
begin
  ClearBase;
end;

procedure Tview_SisGeFExpressExtract.actionClearClientsExecute(Sender: TObject);
begin
  ClearClient;
end;

procedure Tview_SisGeFExpressExtract.actionClearCouriersExecute(Sender: TObject);
begin
  ClearCourier;
end;

procedure Tview_SisGeFExpressExtract.actionCloseExtractExecute(Sender: TObject);
begin
  ClosingExtractDeliveries;
end;

procedure Tview_SisGeFExpressExtract.actionCloseFormExecute(Sender: TObject);
begin
  CloseForm;
end;

procedure Tview_SisGeFExpressExtract.actionComeBackExecute(Sender: TObject);
begin
...
procedure Tview_SisGeFExpressExtract.actionExcludeBasesExecute(Sender: TObject);
begin
  ExcludeBase;
end;

procedure Tview_SisGeFExpressExtract.actionExcludeClientsExecute(Sender: TObject);
begin
  ExcludeClient;
end;

procedure Tview_SisGeFExpressExtract.actionExcludeCouriersExecute(Sender: TObject);
begin
  ExcludeCourier;
end;

procedure Tview_SisGeFExpressExtract.actionExpandGridExecute(Sender: TObject);
begin
  gridExtratoDBTableView1.ViewData.Expand(True);
end;

procedure Tview_SisGeFExpressExtract.actionExportGridExecute(Sender: TObject);
begin
  ExportGrid;
end;

procedure Tview_SisGeFExpressExtract.actionIncludeBasesExecute(Sender: TObject);
begin
  AddBase;
end;

procedure Tview_SisGeFExpressExtract.actionIncludeClientsExecute(Sender: TObject);
begin
  AddClient;
end;

procedure Tview_SisGeFExpressExtract.actionIncludeCouriersExecute(Sender: TObject);
begin
  AddCourier;
end;

procedure Tview_SisGeFExpressExtract.actionPanelGroupExecute(Sender: TObject);
begin
  gridExtratoDBTableView1.OptionsView.GroupByBox := (not gridExtratoDBTableView1.OptionsView.GroupByBox);
end;

procedure Tview_SisGeFExpressExtract.actionProcessExecute(Sender: TObject);
begin
  ProcessExtract;
end;

procedure Tview_SisGeFExpressExtract.actionReopenExtractExecute(Sender: TObject);
begin
  ReopenExtract;
end;

procedure Tview_SisGeFExpressExtract.actionRetractGridExecute(Sender: TObject);
begin
  gridExtratoDBTableView1.ViewData.Collapse(False);
end;

procedure Tview_SisGeFExpressExtract.AddBase;
var
...
procedure Tview_SisGeFExpressExtract.AddClient;
var
  FCode, FName, FItem: string;
begin
...
procedure Tview_SisGeFExpressExtract.AddCourier;
var
  FCode, FName, FItem: string;
begin
...
procedure Tview_SisGeFExpressExtract.ClearBase;
begin
  listaBases.Items.Clear;
end;

procedure Tview_SisGeFExpressExtract.ClearClient;
begin
  listaClientes.Items.Clear;
end;

procedure Tview_SisGeFExpressExtract.ClearCourier;
begin
  listaEntregadores.Items.Clear
end;

procedure Tview_SisGeFExpressExtract.CloseForm;
begin
  Close;
end;

procedure Tview_SisGeFExpressExtract.ClosingExtractDeliveries;
var
...
function Tview_SisGeFExpressExtract.ConfirmUserPwd: boolean;
begin
  Result := False;
...
procedure Tview_SisGeFExpressExtract.dsExtractStateChange(Sender: TObject);
begin
...
procedure Tview_SisGeFExpressExtract.ExcludeBase;
begin
...
procedure Tview_SisGeFExpressExtract.ExcludeClient;
begin
...
procedure Tview_SisGeFExpressExtract.ExcludeCourier;
begin
...
procedure Tview_SisGeFExpressExtract.ExportGrid;
var
...
function Tview_SisGeFExpressExtract.FilterBase: string;
var
  FResult : TStringList;
  sFilter: String;
  i : integer;
...
function Tview_SisGeFExpressExtract.FilterClient: string;
var
  FResult : TStringList;
  sFilter: String;
  i : integer;
...
function Tview_SisGeFExpressExtract.FilterCourier: string;
var
  FResult : TStringList;
  sFilter: String;
  i : integer;
...
procedure Tview_SisGeFExpressExtract.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  if Data_Sisgef.memTableExtracts.Active then
    Data_Sisgef.memTableExtracts.Active := False;
  Action := caFree;
  view_SisGeFExpressExtract := nil;
end;

procedure Tview_SisGeFExpressExtract.FormShow(Sender: TObject);
begin
  StartForm;
end;

function Tview_SisGeFExpressExtract.GeneralFilter(): string;
var
...
function Tview_SisGeFExpressExtract.InfortCreditDate(): string;
var
  sReturn: string;
begin
  try
...
procedure Tview_SisGeFExpressExtract.ListFortnights;
var
...
procedure Tview_SisGeFExpressExtract.ListYears;
var
...
procedure Tview_SisGeFExpressExtract.Mode;
begin
...
function Tview_SisGeFExpressExtract.MountPeriodFilter: string;
var
...
procedure Tview_SisGeFExpressExtract.ProcessExtract;
begin
...
procedure Tview_SisGeFExpressExtract.ProcessListExtract;
var
  sPosfix: string;
begin
...
procedure Tview_SisGeFExpressExtract.ProcessNewExtract;
begin
...
procedure Tview_SisGeFExpressExtract.ReopenExtract;
var
...
function Tview_SisGeFExpressExtract.RidePeriod(iYear, iMonth, iFortnight: Integer): string;
var
  parametros : TParametrosControl;
  FDQuery: TFDQuery;
  FConexao : TConexao;
...
procedure Tview_SisGeFExpressExtract.situacaoExtratoPropertiesChange(Sender: TObject);
begin
  Mode;
end;

procedure Tview_SisGeFExpressExtract.StartForm;
begin
  ListYears;
  ListFortnights;
...
procedure Tview_SisGeFExpressExtract.timerTimer(Sender: TObject);
begin
  if timer.Tag = 0 then
  begin
...
procedure Tview_SisGeFExpressExtract.tipoPeriodoPropertiesChange(Sender: TObject);
begin
  case tipoPeriodo.ItemIndex of
...
function Tview_SisGeFExpressExtract.ValidadeProcess: boolean;
begin
  Result := False;
