...
type
  TView_PesquisarGeral = class(TForm)
...
var
  View_PesquisarGeral: TView_PesquisarGeral;
  fdQuery: TFDQuery;
implementation
...
procedure TView_PesquisarGeral.actFecharExecute(Sender: TObject);
begin
  ModalResult := mrClose;
end;

procedure TView_PesquisarGeral.actionLocalizarExecute(Sender: TObject);
begin
  PopulaPesquisa;
end;

procedure TView_PesquisarGeral.actSelecionarExecute(Sender: TObject);
begin
  ModalResult := mrOk;
end;

procedure TView_PesquisarGeral.FormCreate(Sender: TObject);
begin
  FConexao := TConexao.Create;
end;

procedure TView_PesquisarGeral.FormDestroy(Sender: TObject);
begin
  FConexao.Free;
end;

procedure TView_PesquisarGeral.FormShow(Sender: TObject);
begin
  if bOpen then
  begin
...
procedure TView_PesquisarGeral.grdPesquisaEnter(Sender: TObject);
begin
...
procedure TView_PesquisarGeral.grdPesquisaExit(Sender: TObject);
begin
  cxButton2.Default := False;
end;


procedure TView_PesquisarGeral.PopulaPesquisa;
var
  sConsulta: String;
  sWhere1: String;
begin
...
procedure TView_PesquisarGeral.tvPesquisaCellDblClick(Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
