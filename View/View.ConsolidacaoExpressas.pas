...
type
  Tview_ConsolidacaoExpressas = class(TForm)
    ...
    tvFechamentodat_credito: TcxGridDBColumn;
    tvFechamentodom_boleto: TcxGridDBColumn;
    tvFechamentonum_extrato: TcxGridDBColumn;
    tvFechamentoCampoEmpresa: TcxGridDBColumn;
    tvFechamentoCampoCodigoPessoa: TcxGridDBColumn;
    tvFechamentoCampoNomeTitulo: TcxGridDBColumn;
    tvFechamentoCampoCNPJCPFPessoa: TcxGridDBColumn;
    tvFechamentoCampoDtEmissao: TcxGridDBColumn;
    tvFechamentoCampoNumeroTitulo: TcxGridDBColumn;
    tvFechamentoCampoDtVencimento: TcxGridDBColumn;
    tvFechamentoCampoNaturezaLancamento: TcxGridDBColumn;
    tvFechamentoCampoFormaPagamento: TcxGridDBColumn;
    tvFechamentoCampoValorTitulo: TcxGridDBColumn;
