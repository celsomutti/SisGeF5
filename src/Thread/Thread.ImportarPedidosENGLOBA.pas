    ...
    try
      ...
      begin
        ...
        begin
          ...
          begin
            sMensagem := FormatDateTime('yyyy/mm/dd hh:mm:ss', Now) + ' entregador não encontrado ' + FPlanilha.Planilha.Planilha[i].UltimoMotorista;
            UpdateLog(sMensagem);
          ...
          begin
            ...
            begin
              sMensagem := 'Verba do NN ' + FEntregas.Entregas.NN + ' do entregador ' +
                           FPlanilha.Planilha.Planilha[i].UltimoMotorista + ' não atribuida !';
              UpdateLog(sMensagem);
            end;
          end
          else
