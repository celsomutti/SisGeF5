unit Thread.ImportarPedidosRedeForte;

interface

uses
  System.Classes, Control.Entregas, Control.PlanilhaEntradaRedeForte, System.SysUtils, System.DateUtils, Control.VerbasExpressas,
  Control.Bases, Control.EntregadoresExpressas, Generics.Collections, System.StrUtils;

type
  TThread_ImportarPedidosRedeForte = class(TThread)
  private
...

{
  ...
  and UpdateCaption could look like,
    ...
    procedure TThread_ImportarPedidosRedeForte.UpdateCaption;
    begin
...
{ TThread_ImportarPedidosRedeForte }

procedure TThread_ImportarPedidosRedeForte.BeginProcesso;
var
  sMensagem: String;
begin
  sLog := '';
...
procedure TThread_ImportarPedidosRedeForte.Execute;
var
  FEntregadores : TEntregadoresExpressasControl;
  ...
  try
    try
      ...
      begin
        ...
        begin
          SetLength(aParam,3);
          aParam := ['NNCLIENTE', FPlanilha.Planilha.Planilha[i].Entrega, iCodigoCliente];
          ...
          FEntregas.Entregas.Cidade := LeftStr(FPlanilha.Planilha.Planilha[I].Cidade,70);
...
function TThread_ImportarPedidosRedeForte.RetornaVerba(aParam: array of variant): double;
var
  FBase: TBasesControl;
...
procedure TThread_ImportarPedidosRedeForte.TerminateProcess;
begin
  Global.Parametros.pbProcess := False;
end;

procedure TThread_ImportarPedidosRedeForte.UpdateLOG(sMensagem: string);
begin
...
procedure TThread_ImportarPedidosRedeForte.UpdateProgress(dPosition: Double);
begin
