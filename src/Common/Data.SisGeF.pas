...
type
  TData_Sisgef = class(TDataModule)
    ...
    storedProcCreditWhorsheet: TFDStoredProc;
    ...
    memTableBIMERCP: TFDMemTable;
    memTableBIMERCPCampoEmpresa: TStringField;
    memTableBIMERCPCampoCodigoPessoa: TStringField;
    memTableBIMERCPCampoNomeTitulo: TStringField;
    memTableBIMERCPCampoCNPJCPFPessoa: TStringField;
    memTableBIMERCPCampoDtEmissao: TStringField;
    memTableBIMERCPCampoNumeroTitulo: TStringField;
    memTableBIMERCPCampoDtVencimento: TStringField;
    memTableBIMERCPCampoNaturezaLancamento: TStringField;
    memTableBIMERCPCampoFormaPagamento: TStringField;
    memTableBIMERCPCampoValorTitulo: TStringField;
    memTableBIMERCPCampoAgencia: TStringField;
    ...
    queryFuncionariosnom_razao_social: TStringField;
    queryFuncionariosnom_fantasia_alias: TStringField;
    queryFuncionariosnum_cpf_cnpj: TStringField;
    queryFuncionariosnum_rg_ie: TStringField;
    queryFuncionariosdat_emissao_rg: TDateTimeField;
    queryFuncionariosnom_emissor_rg: TStringField;
    queryFuncionariosuf_emissor_rg: TStringField;
    queryFuncionariosdat_nascimento: TDateField;
    queryFuncionariosdes_nacionalidade: TStringField;
    queryFuncionariosdes_naturalidade: TStringField;
    queryFuncionariosuf_naturalidade: TStringField;
    queryFuncionariosnom_pai: TStringField;
    queryFuncionariosnom_mae: TStringField;
    queryFuncionarioscod_cnae: TStringField;
    queryFuncionarioscod_crt: TIntegerField;
    queryFuncionariosnum_cnh: TStringField;
    queryFuncionariosnum_registro_cnh: TStringField;
    queryFuncionariosdes_categoria_cnh: TStringField;
    queryFuncionariosdat_validade_cnh: TDateField;
    queryFuncionariosdat_emissao_cnh: TDateField;
    queryFuncionariosuf_cnh: TStringField;
    queryFuncionariosdat_primeira_cnh: TDateField;
    queryFuncionarioscod_seguranca_cnh: TStringField;
    queryFuncionarioscod_status: TIntegerField;
    queryFuncionariosdat_cadastro: TDateTimeField;
    queryFuncionariosdes_forma_pagamento: TStringField;
    queryFuncionariosdes_tipo_conta: TStringField;
    queryFuncionarioscod_banco: TStringField;
    queryFuncionarioscod_agencia: TStringField;
    queryFuncionariosnum_conta: TStringField;
    queryFuncionariosnom_favorecido: TStringField;
    queryFuncionariosnum_cpf_cnpj_favorecido: TStringField;
    queryFuncionarioscod_pix: TStringField;
    queryFuncionarioscod_gr: TStringField;
    queryFuncionariosdat_gr: TDateField;
    queryFuncionarioscod_mei: TStringField;
    queryFuncionariosdes_razao_mei: TStringField;
    queryFuncionariosnom_fantasia_mei: TStringField;
    queryFuncionariosnum_cnpj_mei: TStringField;
    queryFuncionariosdat_abertura_mei: TDateField;
    queryFuncionariosdes_obs: TMemoField;
    queryFuncionariosid_departamento: TIntegerField;
    queryFuncionariosid_funcao: TIntegerField;
    queryFuncionariosdat_demissao: TDateField;
    queryFuncionariosEnderecos: TFDQuery;
    queryFuncionariosEnderecosid_endereco: TIntegerField;
    queryFuncionariosEnderecosid_funcionario: TIntegerField;
    queryFuncionariosEnderecosdes_tipo: TStringField;
    queryFuncionariosEnderecosnum_cep: TStringField;
    queryFuncionariosEnderecosdes_logradouro: TStringField;
    queryFuncionariosEnderecosnum_logradouro: TStringField;
    queryFuncionariosEnderecosdes_complemento: TStringField;
    queryFuncionariosEnderecosdes_bairro: TStringField;
    queryFuncionariosEnderecosnom_cidade: TStringField;
    queryFuncionariosEnderecosuf_estado: TStringField;
    queryFuncionariosEnderecosdes_referencia: TStringField;
    queryFuncionariosFinanceiro: TFDQuery;
    queryFuncionariosFinanceiroid_financeiro: TFDAutoIncField;
    queryFuncionariosFinanceirocod_cadastro: TIntegerField;
    queryFuncionariosFinanceirocod_banco: TStringField;
    ...
    queryFuncoesRH: TFDQuery;
    queryFuncoesRHid_funcao: TFDAutoIncField;
    queryFuncoesRHdes_funcao: TStringField;
    queryEstados: TFDQuery;
    queryEstadosUF_ESTADO: TStringField;
    queryEstadosNOM_ESTADO: TStringField;
    queryBancos: TFDQuery;
    queryBancoscod_banco: TStringField;
    queryBancosnom_banco: TStringField;
