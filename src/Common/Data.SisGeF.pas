...
type
  TData_Sisgef = class(TDataModule)
    ...
    queryFuncionariosSEQ_ACAREACAO: TFDAutoIncField;
    queryFuncionariosID_ACAREACAO: TStringField;
    queryFuncionariosCOD_CLIENTE: TIntegerField;
    queryFuncionariosNOM_CLIENTE: TStringField;
    queryFuncionariosDAT_ACAREACAO: TDateTimeField;
    queryFuncionariosNUM_NOSSONUMERO: TStringField;
    queryFuncionariosCOD_ENTREGADOR: TIntegerField;
    queryFuncionariosNOM_MOTORISTA: TStringField;
    queryFuncionariosCOD_BASE: TIntegerField;
    queryFuncionariosNOM_BASE: TStringField;
    queryFuncionariosDAT_ENTREGA: TDateField;
    queryFuncionariosDES_MOTIVO: TStringField;
    queryFuncionariosDES_TRATATIVA: TStringField;
    queryFuncionariosDES_APURACAO: TStringField;
    queryFuncionariosDES_RESULTADO: TStringField;
    queryFuncionariosVAL_EXTRAVIO: TFloatField;
    queryFuncionariosVAL_MULTA: TFloatField;
    queryFuncionariosDES_ENVIO_CORRESPONDENCIA: TStringField;
    queryFuncionariosDES_RETORNO_CORRESPONDENCIA: TStringField;
    queryFuncionariosDES_OBSERVACOES: TMemoField;
    queryFuncionariosDOM_FINALIZAR: TShortintField;
    queryFuncionariosDES_EXECUTOR: TStringField;
    queryFuncionariosDAT_MANUTENCAO: TDateTimeField;
    queryFuncionariosDAT_RETORNO: TDateTimeField;
    queryFuncionariosDES_UNIDADE: TStringField;
    ...
    queryFuncionariosDES_BAIRRO: TStringField;
    queryFuncionariosDES_CIDADE: TStringField;
    queryFuncionariosNUM_CEP: TStringField;
    queryFuncionariosDES_REMETENTE: TStringField;
    queryFuncionariosDES_PRODUTO: TStringField;
    queryFuncionariosNOM_RECEBEDOR: TStringField;
    queryFuncionariosDES_IDENTIFICACAO: TStringField;
    queryFuncionariosDES_DOCUMENTO: TStringField;
