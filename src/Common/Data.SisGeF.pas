...
type
  TData_Sisgef = class(TDataModule)
    ...
    queryFuncionariosNOM_PROPRIETARIO: TStringField;
    queryFuncionariosDAT_NASCIMENTO: TDateField;
    queryFuncionariosNOM_MAE: TStringField;
    queryFuncionariosNOM_PAI: TStringField;
    queryFuncionariosNUM_RG: TStringField;
    queryFuncionariosUF_RG: TStringField;
    queryFuncionariosDAT_EMISSAO_RG: TDateField;
    queryFuncionariosUF_ENDERECO: TStringField;
    queryFuncionariosNOM_CIDADE: TStringField;
    queryFuncionariosDES_ENDERECO: TStringField;
    queryFuncionariosNUM_CEP: TStringField;
    queryFuncionariosDES_BAIRRO: TStringField;
    queryFuncionariosNUM_TELEFONE_1: TStringField;
    queryFuncionariosDES_TELEFONE_1: TStringField;
    queryFuncionariosNUM_TELEFONE_2: TStringField;
    queryFuncionariosDES_TELEFONE_2: TStringField;
    queryFuncionariosCOD_ENTREGADOR: TIntegerField;
    queryFuncionariosDES_MARCA: TStringField;
    queryFuncionariosDES_MODELO: TStringField;
    queryFuncionariosDES_PLACA: TStringField;
    queryFuncionariosUF_PLACA: TStringField;
    queryFuncionariosNOM_CIDADE_PLACA: TStringField;
    queryFuncionariosDES_TIPO: TStringField;
    queryFuncionariosNUM_CHASSIS: TStringField;
    queryFuncionariosDES_ANO: TStringField;
    queryFuncionariosDES_COR: TStringField;
    queryFuncionariosNUM_RENAVAN: TStringField;
    queryFuncionariosANO_EXERCICIO_CLRV: TStringField;
    queryFuncionariosDOM_RASTREAMENTO: TStringField;
