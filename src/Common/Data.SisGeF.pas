...
type
  TData_Sisgef = class(TDataModule)
    ...
    memAcareacoesBlink: TFDMemTable;
    memAcareacoesBlinkFIdTicket: TStringField;
    memAcareacoesBlinkFAssignment: TStringField;
    memAcareacoesBlinkFSPXTN: TStringField;
    memAcareacoesBlinkFStation: TStringField;
    memAcareacoesBlinkFAssignee: TStringField;
    memAcareacoesBlinkFRejection: TStringField;
    memAcareacoesBlinkFStatus: TStringField;
    memAcareacoesBlinkidCliente: TIntegerField;
    memAcareacoesBlinkCreatedTime: TDateTimeField;
    memAcareacoesBlinkFDriver: TIntegerField;
    ...
    qryCandidatosNUM_CEP: TStringField;
    qryContratados: TFDQuery;
    qryContratadosid: TIntegerField;
    qryContratadoscod_erp_contratados: TStringField;
    qryContratadosid_categoria: TIntegerField;
    qryContratadosdes_categoria: TStringField;
    qryContratadoscod_pessoa: TIntegerField;
    qryContratadosdes_tipo_doc: TStringField;
    qryContratadosnom_razao_social: TStringField;
    qryContratadosnom_fantasia_alias: TStringField;
    qryContratadosnum_cpf_cnpj: TStringField;
    qryContratadosnum_rg_ie: TStringField;
    qryContratadosnum_im: TStringField;
    qryContratadosdat_emissao_rg: TDateTimeField;
    qryContratadosnom_emissor_rg: TStringField;
    qryContratadosuf_emissor_rg: TStringField;
    qryContratadosdat_nascimento: TDateField;
    qryContratadosdes_nacionalidade: TStringField;
    qryContratadosdes_naturalidade: TStringField;
    qryContratadosuf_naturalidade: TStringField;
    qryContratadosnom_pai: TStringField;
    qryContratadosnom_mae: TStringField;
    qryContratadoscod_crt: TIntegerField;
    qryContratadosnum_cnh: TStringField;
    qryContratadosnum_registro_cnh: TStringField;
    qryContratadosdes_categoria_cnh: TStringField;
    qryContratadosdat_validade_cnh: TDateField;
    qryContratadosdat_emissao_cnh: TDateField;
    qryContratadosuf_cnh: TStringField;
    qryContratadosdat_primeira_cnh: TDateField;
    qryContratadoscod_status: TIntegerField;
    qryContratadosdat_cadastro: TDateTimeField;
    qryContratadosdes_obs: TMemoField;
    qryContratadoscod_base: TIntegerField;
    qryContratadosnom_base: TStringField;
    qryContratadosdes_funcao: TStringField;
    qryContratadosid_gr: TIntegerField;
    qryContratadosdat_consulta_gr: TDateField;
    qryContratadosdat_validade_gr: TDateField;
    qryContratadosnom_empresa: TStringField;
    qryContratadoscod_consulta_gr: TStringField;
    qryContratadosid_representante: TFDAutoIncField;
    qryContratadosnom_representante: TStringField;
    qryContratadoscpf_representante: TStringField;
    qryContratadoscod_veiculo: TIntegerField;
    qryContratadosdes_marca: TStringField;
    qryContratadosdes_modelo: TStringField;
    qryContratadosdes_placa: TStringField;
    qryContratadosdes_tipo_veiculo: TStringField;
    qryContratadosnum_chassis: TStringField;
    qryContratadosdes_ano: TStringField;
    qryContratadosdes_cor: TStringField;
    qryContratadosnum_renavan: TStringField;
    qryContratadosano_exervicio_clrv: TStringField;
