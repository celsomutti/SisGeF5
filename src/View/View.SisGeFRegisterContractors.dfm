object view_SisGeFRegisterContractors: Tview_SisGeFRegisterContractors
  ...
  object memTableRecords: TFDMemTable
    ...
    object memTableRecordscod_entregador: TIntegerField
      DisplayLabel = 'C'#243'digo Entregador'
      FieldName = 'cod_entregador'
    end
    object memTableRecordsnom_entregador: TStringField
  ...
  object memTableDocuments: TFDMemTable
    ...
    object memTableDocumentsnom_base: TStringField
      DisplayLabel = 'Nome da Base'
      FieldName = 'nom_base'
      Size = 80
    end
    object memTableDocumentscod_entregador: TIntegerField
      DisplayLabel = 'C'#243'd. Entregador'
      FieldName = 'cod_entregador'
    end
    object memTableDocumentsnom_entregador: TStringField
  ...
  object memTableGR: TFDMemTable
    ...
    object memTableGRnom_base: TStringField
      DisplayLabel = 'Nome da Base'
      FieldName = 'nom_base'
      Size = 80
    end
    object memTableGRcod_entregador: TIntegerField
      DisplayLabel = 'C'#243'd. Entregador'
      FieldName = 'cod_entregador'
    end
    object memTableGRnom_entregador: TStringField
      DisplayLabel = 'Nome Entregador'
      FieldName = 'nom_entregador'
      Size = 70
    end
  ...
  object queryRegister: TFDQuery
    ...
    object queryRegisternom_base: TStringField
      DisplayLabel = 'Nome Base'
      FieldName = 'nom_base'
      Size = 80
    end
    object queryRegistercod_entregador: TIntegerField
      DisplayLabel = 'C'#243'd. Entregador'
      FieldName = 'cod_entregador'
    end
    object queryRegisternom_entregador: TStringField
      DisplayLabel = 'Nome Entregador'
      FieldName = 'nom_entregador'
      Size = 70
    end
