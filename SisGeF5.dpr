...
uses
  ...
  Model.EmpresasContatos in 'Model\Model.EmpresasContatos.pas',
  Control.ContatosContatos in 'Control\Control.ContatosContatos.pas',
  ...
  Model.EmpresasEnderecos in 'Model\Model.EmpresasEnderecos.pas',
  Control.EmpresasEnderecos in 'Control\Control.EmpresasEnderecos.pas',
  ...
  Model.CRMContatosClientes in 'Model\Model.CRMContatosClientes.pas',
  Model.CRMClientes in 'Model\Model.CRMClientes.pas',
  Model.CRMEnderecosClientes in 'Model\Model.CRMEnderecosClientes.pas',
  ...
  Controller.CRMCNAEClientes in 'Control\Controller.CRMCNAEClientes.pas',
  Model.CRMFinanceiroClientes in 'Model\Model.CRMFinanceiroClientes.pas',
  Controller.CRMFinanceiroClientes in 'Control\Controller.CRMFinanceiroClientes.pas',
