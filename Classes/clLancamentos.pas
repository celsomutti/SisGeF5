...
type
  ...
  public
    ...
    function Totalizacao(sdtInicial, sdtFinal, sEntregador,
      filtro: String): Double;
    function Periodo(sdtInicial, sdtFinal, sEntregador, filtro: String)
      : Boolean;
    function Fechar(sdtInicial, sdtFinal, sdtDesconto, sNumero, sEntregador,
