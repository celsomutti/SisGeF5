...
begin
  Try
    ...
    begin
      Close;
      SQL.Clear;
      SQL.Text := 'INSERT INTO ' + TABLENAME + ' (COD_EXTRAVIO, ' +
        'DES_EXTRAVIO, ' + 'NUM_NOSSONUMERO, ' + 'COD_AGENTE, ' +
        'VAL_PRODUTO, ' + 'DAT_EXTRAVIO, ' + 'VAL_MULTA, ' + 'VAL_VERBA, ' +
        'VAL_TOTAL, ' + 'DOM_RESTRICAO, ' + 'COD_ENTREGADOR, ' +
        'NOM_EXECUTOR, ' + 'DAT_MANUTENCAO, ' + 'COD_TIPO, ' +
        'VAL_EXTRATO_FRANQUIA, ' + 'DOM_EXTRATO_FRANQUIA, ' +
        'DES_ENVIO_CORRESPONDENCIA, ' + 'DES_RETORNO_CORRESPONDENCIA, ' +
        'DES_OBSERVACOES) ' + 'VALUES ' + '(:CODIGO, ' + ':DESCRICAO, ' +
        ':NOSSONUMERO, ' + ':AGENTE, ' + ':PRODUTO, ' + ':DATA, ' + ':MULTA, ' +
        ':VERBA, ' + ':TOTAL, ' + ':RESTRICAO, ' + ':ENTREGADOR, ' +
        ':EXECUTOR, ' + ':MANUTENCAO, ' + ':TIPO, ' + ':VALDEBITO, ' +
        ':DEBITO, ' + ':ENVIO, ' + ':RETORNO, ' + ':OBS)';
      MaxCod;
      ParamByName('CODIGO').AsInteger := Self.Codigo;
