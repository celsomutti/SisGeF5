...
type
  TData_Sisgef = class(TDataModule)
    ...
    storedProccod_base: TIntegerField;
    storedProcnom_base: TStringField;
    storedProccod_entregador: TIntegerField;
    storedProcnom_entregador: TStringField;
    storedProcval_verba: TFloatField;
    storedProcqtd_volumes: TFMTBCDField;
    storedProcqtd_entregas: TLargeintField;
    storedProcqtd_atraso: TFMTBCDField;
    storedProcval_performance: TFMTBCDField;
    storedProcval_producao: TFloatField;
    storedProccod_cliente: TIntegerField;
    storedProcnom_cliente: TStringField;
    storedProcdat_baixa: TDateField;
