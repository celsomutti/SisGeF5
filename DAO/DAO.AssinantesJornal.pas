...
begin
  ...
  Connection.ExecSQL(sSQL,[aAssinaturas.ID, aAssinaturas.Codigo, aAssinaturas.Modalidade, aAssinaturas.Produto, aAssinaturas.Ordem,
                          ...
                          [ftInteger, ftInteger, ftString, ftInteger, ftInteger, ftString, ftString, ftString, ftString, ftString,
...
begin
  ...
  Connection.ExecSQL(sSQL,[aAssinaturas.Codigo, aAssinaturas.Modalidade, aAssinaturas.Produto, aAssinaturas.Ordem, aAssinaturas.Qtde,
                          ...
                          aAssinaturas.Estado, aAssinaturas.CEP, aAssinaturas.Referencia, aAssinaturas.Roteiro, aAssinaturas.Log,
                          aAssinaturas.ID],
                          [ftInteger, ftString, ftInteger, ftInteger, ftString, ftString, ftString, ftString, ftString,
                          ftString, ftString, ftString, ftString, ftString, ftString, ftString, ftInteger]);
  Result := True;
end;
...
begin
  ...
  try
    ...
    FDQuery.SQL.Clear;
    FDQuery.SQL.Add('SELECT * FROM ' + TABLENAME);
    FDQuery.SQL.Add('WHERE COD_ASSINANTE = :pCOD_ASSINANTE');
